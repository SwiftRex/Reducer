...
class ReducerTests: XCTestCase {
    ...
    func testComposeTwoReducers() {
        ...
        let sut = Reducer.compose(reducer1, reducer2)
    ...
    func testComposeThreeReducers() {
        ...
        let sut = Reducer.compose(reducer1, reducer2, reducer3)
    ...
    func testComposeTwoGroupsOfReducers() {
        ...
        let sut = Reducer.compose(Reducer.compose(reducer1, reducer2), Reducer.compose(reducer3, reducer4))
    ...
    func testLiftReducerToCollectionIdentifiableRelevantAction() {
        ...
        let liftedReducer: Reducer<ActionForScopedTests, AppState> = reducer
            .liftToCollection(action: \.somethingScopedById?.tuple, stateCollection: \.list)
    ...
    func testLiftReducerToCollectionKeyPathIdentifierRelevantAction() {
        ...
        let liftedReducer: Reducer<ActionForScopedTests, AppState> = reducer
            .liftToCollection(
                action: \.somethingScopedById?.tuple,
    ...
    func testLiftReducerToCollectionIndexedRelevantAction() {
        ...
        let liftedReducer: Reducer<ActionForScopedTests, AppState> = reducer
            .liftToCollection(action: \.somethingScopedByIndex?.tuple, stateCollection: \.list)
